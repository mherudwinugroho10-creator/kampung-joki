...
export default function Analytics() {
  ...
  // filtered: untuk stat cards, pie charts, worker table, rekap detail
  ...
  // Stat cards — semua status, bukan hanya done
  ...
  // Chart tren 6 bulan — pakai semua orders (tidak difilter tahun/bulan)
